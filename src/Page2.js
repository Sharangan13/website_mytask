...
export default function Page2() {
  return (
    <div className="py-10">
      <section className="flex flex-col lg:flex-row px-8 lg:px-16 pt-20 pb-32  justify-between items-start bg-secoundary">
        ...
        <div className="w-3/5 flex justify-center relative ">
          <div className="w-full absolute top-20 right-4">
            <img src={Group_img} alt="Group Image" className="min-w-[300px]"/>
            <div className="absolute lg:block hidden" style={{ top: "-35px", left: "155px" }}>
              <button className="px-3 py-2 mx-2 rounded-full bg-btnbg text-btn1 text-[15px] font-semibold bg-secoundary">
                WEALTH
              </button>
            </div>
            ...
            <div className="absolute lg:block hidden" style={{ left: "625px", top: "-95px" }}>
              <button className="px-3 py-2 mx-2 rounded-full bg-btnbg text-btn1 text-[15px] font-semibold">
                VENTURE
              </button>
            </div>
          ...
          <div className="w-1/2 relative">
            <img src={wealth_img} alt="Wealth Image" className="min-w-[300px]"/>
          </div>
        </div>
      </section>
    </div>
